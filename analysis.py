...
for i in range (0,parameter.shape[0]):
    ...
    delta = (end_val-start_val)/(s.grid_resolution-1)
    ...
    for j in range (0,s.grid_resolution):
        parameter_list.iloc[j,i] = values[j] #falls wir eine ein dimensionale liste mit allen werten brauchen, kann diese zeile einfach geändert werden
