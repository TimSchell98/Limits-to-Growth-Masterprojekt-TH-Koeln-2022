...
# Death rate (might delete later)
cdr_data_big = pd.read_csv('Data_death_rate1.csv')
cdr_data = cdr_data_big.iloc[0:1, 19:]              # Data from 1970 - 2021
cdr_data = np.transpose(cdr_data.values.tolist())

# Food per capita

#Data frame for observed Data
observed_data_df = {"pop": pop_data,
                    "cdr_data": cdr_data}
