...
def plot_world_variables_black_linestyle(time, var_data, var_names, var_lims, alpha, linestyle,
                         img_background=None,
                         title=None,
                         figsize=None,
                         dist_spines=0.09,
    ...
    ps = []
    for ax, label, ydata, linestyle, alpha in zip(axs, var_names, var_data, linestyle, alpha):
        ps.append(ax.plot(time, ydata, label=label, color = 'black', linestyle=linestyle, alpha=alpha)[0])
    axs[0].grid(grid)
